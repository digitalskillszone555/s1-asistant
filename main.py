...
from utils.device_detector import detect_device_type
...
def run_core_logic(config: dict, shutdown_event: threading.Event):
    ...
    auto_mode_manager = get_auto_mode_manager()
    auto_mode_manager.start()
